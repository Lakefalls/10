...
HTMLActuator.prototype.addTile = function (tile) {
  ...
  if (tile.value === -3) inner.textContent = "X";
  if (tile.value === -4) inner.textContent = "0";
  if (tile.value === -5) inner.textContent = "0";
  if (tile.value === -8) inner.textContent = 8;
  if (tile.value === -9) inner.textContent = 9;
  if (tile.value === -18) inner.textContent = 18;
  if (tile.value === -18) inner.textContent = 19;
  ...
  if (tile.value === -41) inner.textContent = 41;
  if (tile.value === -45) inner.textContent = 45;
  if (tile.value === -50) inner.textContent = 50;
  ...
  if (tile.value === -97) inner.textContent = 97;
  if (tile.value === -98) inner.textContent = 98;
  if (tile.value === -99) inner.textContent = 99;
  if (tile.value === -100) inner.textContent = 100;
